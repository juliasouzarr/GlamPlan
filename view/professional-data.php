            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="../controller/delete-professional.php?id=<?= $professional['id']; ?>" class="btn-delete" onclick="return confirm('Tem certeza que deseja excluir esta conta profissional?');">Excluir</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
